...
export function MediosDePagoPage() {
  ...
  // Persistent activation state — survives tab switches and subsequent visits
  const activated =
  ...
  const showPagoNube = activeTab === "Todos" || activeTab === "Activados";
  ...
  return (
    <SettingsShell>
      <div className="medios-pago-page">
        ...
        {showPagoNube && <PagoNubeHeroCard activated={activated} />}
